...
export const post = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        "The last part of the address: mfe-orchestrator.dev/blog/this-bit. Generate it from the title. Do NOT change it after publishing — anyone who saved or linked the old URL lands on a 404.",
      options: {
        source: "title",
        maxLength: 80,
